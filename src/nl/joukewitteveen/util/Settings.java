...
public class Settings implements CommandListener {
	...
	public static void readValues() {
		try {
			...
			if(!(recordStore.getNumRecords() == 3 && recordStore.getNextRecordID() == 4)) {
			...
			Values.activeLighting = (recordStore.getRecord(3)[0] == 0) ? false : true;
			recordStore.closeRecordStore();
		} catch (Exception e) {
	...
	public Displayable getDisplayable() {
		...
		((ChoiceGroup) menu.get(2)).setSelectedIndex(0, Values.activeLighting);
